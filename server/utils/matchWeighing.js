...
export function calculateMatchWeight(match, leaguePriority, standings, teamForm) {
  const breakdown = {
    leagueWeight: 0,
    stageWeight: 0,
    teamWeight: 0,
...
export function getTopWeightedMatches(matches, standings, teamForm, leaguePriorities, limit = 5) {
