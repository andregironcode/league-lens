/**
 * FIX LEAGUE LOGOS - CORRECTED VERSION
 * 
 * Uses correct database schema (priority as boolean)
 */
...
async function fixLeagueLogos() {
  console.log('🚀 FIXING LEAGUE LOGOS - CORRECTED');
  ...
  const knownLeagues = [
    {
      ...
      priority: true // Top priority league
    },
    {
      id: 119924,
      name: 'La Liga',
  ...
  const newLeagues = [
    {
      ...
      priority: false // Secondary league
    },
    {
      id: 999002,
      name: 'MLS',
